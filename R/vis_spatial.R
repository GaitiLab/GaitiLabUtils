...
#' @export
visualize_transcripts <- function(
    gene = NULL,
    transcripts,
    n_bins = 100,
    output_dir = ".",
    ...
    p <- ggplot2::ggplot(transcripts_subset) +
        ggrastr::geom_point_rast(
            ggplot2::aes(x_location, y_location, color = density),
    ...
    if (save_plot) {
        if (is.null(gene)) {
            ...
            ggplot2::ggsave(
                ...
                filename = file.path(
                    output_dir,
                    paste0("transcript_distribution_", gene, ".pdf")
                ),
                width = 10,
                height = 10
            )
            ...
            ggplot2::ggsave(
                ...
                filename = file.path(
                    output_dir,
                    "transcript_distribution_multi_genes.pdf"
                ),
                width = 10,
                height = 10
            )
